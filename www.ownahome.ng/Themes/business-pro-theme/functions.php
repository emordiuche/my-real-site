...
function business_scripts_styles() {
	...
	wp_enqueue_style( 'bootstrap-css', '//stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css');
		...
		// Enqueue W3.CSS style
	wp_enqueue_style( 'W3-css', '//www.w3schools.com/w3css/4/w3.css');
	...
	// Dequeue Line Awesome icon font.
	if ( 'line-awesome' !== $icon_settings['font'] ) {

		wp_dequeue_style( 'business-pro-icons', get_stylesheet_directory_uri() . '/assets/styles/min/line-awesome.min.css', array(), CHILD_THEME_VERSION );
...
add_action( 'wp_print_styles', 'enqueue_our_required_stylesheets', 999);
	
	// Enqueue Awesome Fonts
function own_ng_awesome_icons(){
	wp_enqueue_style('font-awesome-free', '//use.fontawesome.com/releases/v5.12.0/css/all.css'); 
}
add_action('wp_enqueue_scripts','own_ng_awesome_icons', 999);
...
function woocommerce_custom_single_add_to_cart_text() {
    return __( 'Book Inspection', 'woocommerce' ); 
}
